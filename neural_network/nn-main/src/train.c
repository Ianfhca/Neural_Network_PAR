...
//     GPU_matrix_free_2D(D_aux, n_l - 1);
//     GPU_matrix_free_2D(E, n_l - 1);
...
//     // cudaMalloc(&GA, nn->n_layers * sizeof(double*));
//     // cudaMalloc(&GZ, nn->n_layers * sizeof(double*));
//     // cudaMalloc(&GW, nn->n_layers * sizeof(double*));
//     // cudaMalloc(&GB, nn->n_layers * sizeof(double*));

//     // for (i = 0; i < nn->n_layers; i++) {
//     //     cudaMalloc(&GA[i], nn->layers_size[i] * sizeof(double));
//     //     cudaMalloc(&GZ[i], nn->layers_size[i] * sizeof(double));
//     //     cudaMalloc(&GW[i], nn->layers_size[i] * sizeof(double));
//     //     cudaMalloc(&GB[i], nn->layers_size[i] * sizeof(double));
//     //     cudaMemcpy(GA[i], A, nn->layers_size[i] * sizeof(double), cudaMemcpyHostToDevice);
//     //     cudaMemcpy(GZ[i], Z, nn->layers_size[i] * sizeof(double), cudaMemcpyHostToDevice);
//     //     cudaMemcpy(GB[i], nn->BH[i], nn->layers_size[i] * sizeof(double), cudaMemcpyHostToDevice);
//     // }
...
//     // dimGrid = dim3((nn->n_layers + dimBlock.x - 1) / dimBlock.x, (nn->n_layers + dimBlock.y - 1) /dimBlock.y);

//     for(i = 1; i < nn->n_layers; i++) {
//         // cudaMalloc(&GA[i], nn->layers_size[i] * sizeof(double));
//         // cudaMalloc(&GZ[i], nn->layers_size[i] * sizeof(double));
//         // cudaMalloc(&GW[i], nn->layers_size[i] * nn->layers_size[i - 1]* sizeof(double));
//         // cudaMalloc(&GB[i], nn->layers_size[i] * sizeof(double));
